...
/**
 * A common interface for resource methods, sub-resource methods and sub-resource
 * locators directly bound to a concrete Java method.
 * <p />
 * These methods of the declaring resource class are invoked by a Java method
 * dispatcher at runtime.
 *
 * @see ResourceMethod
 * @see SubResourceMethod
 * @see SubResourceLocator
...
public interface InvocableResourceMethod extends Parameterized, ConsumesProducesEnabledComponent, SuspendableComponent {
     ...
     *
     * @return the enclosing resource class instance.
     */
     ...
     *
     * @return corresponding Java method generic return type
     */
