...
/**
 * MXBean implementing the {@link org.glassfish.jersey.server.monitoring.ResponseMXBean} MXBean interface.
...
public class ResponseMXBeanImpl implements ResponseMXBean {
    ...
    public Map<Integer, Long> getResponseCodesToCountMap() {
        return responseStatistics.getResponseCodes();
    }

    @Override
    public Integer getLastResponseCode() {
        return responseStatistics.getLastResponseCode();
    }
