...
/**
 * Tests programmatic resources.
 *
 * @author Miroslav Fuksa (miroslav.fuksa at oracle.com)
 *
 */
public class ProgrammaticResourceTest {
    @Path("root")
    ...
    @Test
    public void testInstanceBasedResources() throws ExecutionException, InterruptedException {
        ...
        response = ah.apply(RequestContextBuilder.from("/root", "GET").build()).get();
        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("101", response.getEntity());
    }
