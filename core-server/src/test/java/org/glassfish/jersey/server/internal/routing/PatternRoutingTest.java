...
public class PatternRoutingTest {
    ...
    public void setupApplication() {
        ...
        this.invoker = invokerBuilder.build(routeBuilder.root(
                routeBuilder.route("a(/.*)?").to(LastPathSegmentTracingFilter.class)
                        ...
                        .build()));
        requestScope = locator.createAndInitialize(RequestScope.class);
    }
    ...
    public void testPatternRouting() throws Exception {
        ...
        Future<ContainerResponse> res = requestScope.runInScope(
                new Callable<Future<ContainerResponse>>() {
