...
/**
 * This mojo stops Tomcat.
 *
 * @author Stepan Vavra (stepan.vavra at oracle.com)
 */
@Mojo(name = "stopTomcat")
class StopTomcatMojo extends AbstractTomcatRunnerMojo implements CommonStop {

    @Override
    void executeRunner() throws MojoExecutionException, MojoFailureException {
        executeShell("/runner/tomcat/stop.sh")
    }
