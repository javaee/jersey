...
public class TimeoutTest extends JerseyTest {
    ...
    public void testSlow() {
        try {
            ...
            assertThat("Unexpected exception cause", e.getCause(), instanceOf(HystrixRuntimeException.class));
            assertThat("Unexpected wrapped processing exception cause",
                    e.getCause().getCause(), instanceOf(ProcessingException.class));
            assertThat("Unexpected processing exception cause",
                    e.getCause().getCause().getCause(), instanceOf(TimeoutException.class));
        }
    }
}
