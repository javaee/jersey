 ...
 * fully take advantage of ). Web.xml-less deployment of an application using MVC is not supported at the moment.
 *
 * @see org.glassfish.jersey.servlet.mvc.internal.JspTemplateProcessor
 */
