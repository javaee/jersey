...
public class CustomProcessingExecutorsProviderTest {
    ...
    private ServiceLocator init() {
        ...
        final ServiceLocator serviceLocator = Utilities.create(null, null, new ProcessingTestModule());

        ProcessingTestModule.initProviders(serviceLocator, Collections.<Class<?>>emptySet(),
    ...
    public void testCustomProcessingExecutors() throws Exception {
        ...
        final RequestInvoker<String, Response> invoker =
                Utilities.getOrCreateComponent(locator, String2ResponseRequestInvokerBuilder.class)
