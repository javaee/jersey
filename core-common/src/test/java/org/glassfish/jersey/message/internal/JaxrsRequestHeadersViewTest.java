...
public class JaxrsRequestHeadersViewTest {
    ...
    public void testHeader() throws URISyntaxException, ParseException {
        ...
        r.header("FOO", "");
        RequestHeaders v = r.getJaxrsHeaders();
        assertTrue(v.getHeader(HttpHeaders.ACCEPT).contains("application/xml"));
        assertTrue(v.getHeader(HttpHeaders.ACCEPT).contains("text/plain"));
        assertTrue(v.getHeader(HttpHeaders.ACCEPT).contains("application/json"));
        assertEquals(v.getHeader("FOO").length(), 0);
        assertNull(v.getHeader("BAR"));
    }
    ...
    public void testHeaderMap() throws URISyntaxException, ParseException {
        ...
        r.header("Allow", "POST");
        RequestHeaders v = r.getJaxrsHeaders();
        assertTrue(v.asMap().containsKey(HttpHeaders.ACCEPT));
        assertTrue(v.asMap().containsKey("Allow"));
        assertTrue(v.asMap().get(HttpHeaders.ACCEPT).contains("application/json"));
        assertTrue(v.asMap().get("Allow").contains("POST"));
    }
    ...
    public void testHeaderValues() throws URISyntaxException, ParseException {
        ...
        r.header(HttpHeaders.ACCEPT, "application/json");
        RequestHeaders v = r.getJaxrsHeaders();
        assertTrue(v.getHeaderValues(HttpHeaders.ACCEPT).contains("application/xml, text/plain"));
        assertTrue(v.getHeaderValues(HttpHeaders.ACCEPT).contains("application/json"));
    }
