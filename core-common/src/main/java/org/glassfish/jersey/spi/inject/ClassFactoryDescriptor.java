 ...
 */
public class ClassFactoryDescriptor<T> extends Descriptor<T, ClassFactoryDescriptor<T>> {
     ...
     */
    ClassFactoryDescriptor(Class<? extends Factory<T>> factoryClass, Class<? extends Annotation> scope) {
