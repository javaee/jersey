...
public class LoggingFilter_Old implements PreMatchRequestFilter, RequestFilter, ResponseFilter {

    private static final Logger LOGGER = Logger.getLogger(LoggingFilter_Old.class.getName());
     ...
     */
    public LoggingFilter_Old(Logger logger, boolean printEntity) {
        this.logger = logger;
