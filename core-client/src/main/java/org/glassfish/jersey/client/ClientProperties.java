...
public final class ClientProperties {
    ...
    /**
     * An integer value that defines the buffer size used to buffer client-side request entity in order to
     ...
     * </p>
     * This property can be used on the client side to override the outbound message buffer size value - default or the global
