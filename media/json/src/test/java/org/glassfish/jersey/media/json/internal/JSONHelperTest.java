...
public class JSONHelperTest extends TestCase {
    ...
    public void testGetRootElementName() {
        ...
        assertEquals("string", JsonHelper.getRootElementName(clazz));

        clazz = Drink.class;
        assertEquals("drink", JsonHelper.getRootElementName(clazz));

        clazz = JAXBBeanType.class;
        assertEquals("jaxbBeanType", JsonHelper.getRootElementName(clazz));
    }
}
