...
import org.glassfish.jersey.media.json.internal.JSONTestHelper;
...
public class SchemaExtensibilityTest extends TestCase {
    ...
    public void testExtensibility() throws Exception {
        String baseXml = JSONTestHelper.getResourceAsString("org/glassfish/jersey/media/json/internal/rim/", "LightningDataset.xml");
        JsonJaxbContext jsonContext = new JsonJaxbContext(JsonConfiguration.natural().build(), "org.glassfish.jersey.media.json.internal.rim");
