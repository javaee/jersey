 ...
 */
public final class JsonJaxbMarshaller extends BaseJsonMarshaller implements Marshaller {

    public JsonJaxbMarshaller(JAXBContext jaxbContext, JsonConfiguration jsonConfig) throws JAXBException {
