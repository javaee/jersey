 ...
 */
public class JsonJaxbUnmarshaller extends BaseJsonUnmarshaller implements Unmarshaller {

    public JsonJaxbUnmarshaller(JAXBContext jaxbContext, JsonConfiguration jsonConfig) throws JAXBException {
