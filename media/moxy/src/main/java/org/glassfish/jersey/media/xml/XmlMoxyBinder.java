 ...
 */
public class XmlMoxyBinder extends AbstractBinder {
     ...
     */
    public XmlMoxyBinder(Map properties, ClassLoader classLoader, boolean oxmMappingLookup, Class... classes) {
    ...
    protected void configure() {
        bind(new MoxyContextResolver(properties, classLoader, oxmMappingLookup, classes)).to(ContextResolver.class);
    }
}
