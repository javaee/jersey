 ...
 */
public class XmlMoxyFeature implements Feature {
     ...
     */
    public XmlMoxyFeature(Map properties, ClassLoader classLoader, boolean oxmMappingLookup, Class... classes) {
