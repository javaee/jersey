...
/**
 * spring-boot-runner and configuration.
 * 
...
public class MyApplicationRunner {
    ...
    public JettyEmbeddedServletContainerFactory containerFactory() {
        ...
        containerFactory.setPort(port);
        containerFactory.setSessionTimeout(30);
        containerFactory.addInitializers(new MyApplicationWebConfig());
        return containerFactory;
    }

    public class MyApplicationWebConfig implements ServletContextInitializer {

        public MyApplicationWebConfig() {
        }

        @Override
        public void onStartup(ServletContext context) throws ServletException {
            ServletRegistration.Dynamic dispatcher = context.addServlet("jersey", ServletContainer.class);
    ...
    public static class JerseyConfig extends ResourceConfig {
        ...
        public JerseyConfig() {
            packages("org.glassfish.jersey.server.spring.boot.test");
