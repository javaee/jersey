 ...
 */
public class ResolvingClassViewProcessorTest extends JerseyTest {
    ...
    public void testExplicitTemplate() throws IOException {
        ...
        assertEquals("/org/glassfish/jersey/tests/e2e/server/mvc/ResolvingClassViewProcessorTest/ResolvingClass/show.testp", p.getProperty("path"));
