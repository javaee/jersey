...
public class PersonResource {
    ...
    private static final com.yammer.metrics.core.Timer postTimer =
            Metrics.newTimer(PersonResource.class, "posts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer getTimer =
            Metrics.newTimer(PersonResource.class, "gets", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer putTimer =
            Metrics.newTimer(PersonResource.class, "puts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
