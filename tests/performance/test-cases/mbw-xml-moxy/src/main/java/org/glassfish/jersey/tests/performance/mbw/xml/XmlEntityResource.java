...
public class XmlEntityResource {
    ...
    private static final com.yammer.metrics.core.Timer postTimer =
            Metrics.newTimer(XmlEntityResource.class, "posts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer getTimer =
            Metrics.newTimer(XmlEntityResource.class, "gets", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer putTimer =
            Metrics.newTimer(XmlEntityResource.class, "puts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
