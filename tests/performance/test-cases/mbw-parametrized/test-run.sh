...
#this script demonstrates usage of parametrized JerseyApp
# you need to execute ./test-build.sh firstly (see comments in the script_
# usage: ./test-run.sh --help
...
java -server -Xms512m -Xmx1024m -XX:PermSize=256m -XX:MaxPermSize=512m \
      ...
      org.glassfish.jersey.tests.performance.mbw.parametrized.JerseyApp $@
