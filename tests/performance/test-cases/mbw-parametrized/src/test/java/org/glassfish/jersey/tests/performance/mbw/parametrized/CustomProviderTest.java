 ...
 */
public class CustomProviderTest extends JerseyTest {
    ...
    @Test
    public void testGet() {
        final Response response = target().path("person").request("application/person").get();
    ...
    public void testPost() {
        final Response response = target().path("person").request("application/person")
                .post(Entity.entity(JerseyApp.PERSON, "application/person"));
        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals(JerseyApp.PERSON, response.readEntity(Person.class));
    }
    ...
    public void testPut() {
        final Response response = target().path("person").request("application/person")
                .put(Entity.entity(JerseyApp.PERSON, "application/person"));
