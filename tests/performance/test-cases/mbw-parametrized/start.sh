...
#this script executes performance test after it is deployed to the test server
#for standalone testing in the project use test-build.sh and then "test-run.sh --help"
...
java -server -Xms512m -Xmx1024m -XX:PermSize=256m -XX:MaxPermSize=512m \
      ...
      org.glassfish.jersey.tests.performance.mbw.custom.JerseyApp $@
