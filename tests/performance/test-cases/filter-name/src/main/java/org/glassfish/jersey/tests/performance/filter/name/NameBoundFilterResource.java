...
public class NameBoundFilterResource {
    ...
    private static final com.yammer.metrics.core.Timer postTimer =
            Metrics.newTimer(NameBoundFilterResource.class, "posts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer getTimer =
            Metrics.newTimer(NameBoundFilterResource.class, "gets", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
