...
public class DynamicallyBoundFilterResource {
    ...
    private static final com.yammer.metrics.core.Timer postTimer =
            Metrics.newTimer(DynamicallyBoundFilterResource.class, "posts", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
    private static final com.yammer.metrics.core.Timer getTimer =
            Metrics.newTimer(DynamicallyBoundFilterResource.class, "gets", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
