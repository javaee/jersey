...
/**
 * Custom type adapter for serializing type information of polymorphic objects.
 */
public class CustomJsonbAdapter extends PolymorphismAdapter<Animal> {
    public CustomJsonbAdapter() {
