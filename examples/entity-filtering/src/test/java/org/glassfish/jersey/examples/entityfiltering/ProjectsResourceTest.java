...
public class ProjectsResourceTest extends JerseyTest {
    ...
    private void testProject(final Project project, final boolean isDetailed) {
        ...
        if (!isDetailed) {
            assertThat(project.getUsers(), nullValue());
            assertThat(project.getTasks(), nullValue());
        } else {
            assertThat(project.getUsers(), notNullValue());
            assertThat(project.getTasks(), notNullValue());
        }
    }
}
